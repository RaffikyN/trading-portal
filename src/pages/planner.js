      ...
      <div className="p-6 lg:p-8">
        ...
        {activeTab === 'overview' && (
          <div className="space-y-6">
            ...
            <RecurringBillsCalendar expenses={expenses} />
          </div>
        )}
        ...
        {activeTab === 'analytics' && (
          <div className="space-y-6">
            ...
            <IncomeByCategoryChart incomes={incomes} />
                        ...
                        <tr key={expense.id} className="border-b border-trading-gray/30 hover:bg-trading-pink/5 transition-colors">
                          ...
                          <td className="px-4 py-3 text-center">
                            <div className="flex items-center justify-center gap-2">
                              ...
                              {expense.isRecurring && (
                                <Repeat className="h-4 w-4 text-trading-pink" title="Recurring" />
                              )}
                            </div>
                          </td>
                          <td className="px-4 py-3 text-center">
  ...
  return (
    <div className="bg-trading-card/20 backdrop-blur-sm border border-trading-pink/20 rounded-lg p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium text-trading-text mb-2">Description</label>
          <input type="text" value={formData.description} onChange={(e) => setFormData({ ...formData, description: e.target.value })} className="w-full bg-trading-card border border-trading-gray rounded-lg px-3 py-2 text-trading-text focus:border-trading-pink focus:outline-none" placeholder="e.g., Centauro Salary" required />
        </div>
        <div>
          <label className="block text-sm font-medium text-trading-text mb-2">Date</label>
          <input type="date" value={formData.date} onChange={(e) => setFormData({ ...formData, date: e.target.value })} className="w-full bg-trading-card border border-trading-gray rounded-lg px-3 py-2 text-trading-text focus:border-trading-pink focus:outline-none cursor-pointer" required />
        </div>
        <div className="flex gap-6">
          <label className="flex items-center">
            <input type="checkbox" checked={formData.isPaid} onChange={(e) => setFormData({ ...formData, isPaid: e.target.checked })} className="mr-2 accent-trading-pink" />
